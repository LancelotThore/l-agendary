...
const EventHeader = () => {
    return (
        <div className='flex w-full relative overflow-hidden items-end px-3 rounded-3xl bg-gradient-to-b from-transparent from-50% to-primary text-primary-foreground'>
            <img src="https://images.unsplash.com/photo-1680868543815-b8666dba60f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=560&q=80" alt="Card" className='absolute z-[-10] w-full h-full left-0 rounded-3xl'/>
            <div className='w-full flex flex-col mt-48 mb-6 gap-2'>

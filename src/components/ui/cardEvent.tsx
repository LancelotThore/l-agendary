...
export function CardEvent({ nom, lieu, date, img, id }: ToolCardProps) {
  return (
    <li
      key={id}
      className="flex justify-between items-center bg-white w-full h-32 md:w-full 4xl:w-[480px] rounded-3xl shadow-md cursor-pointer transform transition-transform duration-300 ease-in-out hover:scale-105 overflow-hidden"
    >

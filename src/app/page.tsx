...
export default function Home() {
  return (
    <div className="mt-16 w-10/12 m-auto">
      <div className="flex flex-col bg-cover items-center bg-center p-24 px-10 md:px-24 rounded-lg" style={{ backgroundImage: "url('./bgToolCards.webp')" }}>
      ...
      <section className="container mb-20">
        <div className="w-full flex flex-col gap-5 text-sm lg:text-base lg:flex-row-reverse md:w-full">

...
const EventShare = ({ handleShare, token }) => {
      ...
      <div className='flex gap-12 justify-evenly'>
        <div className='pb-16 pt-10'>
          ...
          <ul className='flex gap-5 flex-wrap'>
            <li><a href={`https://www.instagram.com/`} target="_blank" rel="noopener noreferrer"><Instagram className="w-10" /></a></li>
            <li><a href={`https://www.facebook.com/sharer/sharer.php?u=${shareUrl}&quote=${shareText}`} target="_blank" rel="noopener noreferrer"><Facebook className='w-10' /></a></li>
            ...
            <li><a href={`https://www.linkedin.com/shareArticle?mini=true&url=${shareUrl}&title=${shareText}`} target="_blank" rel="noopener noreferrer"><Linkedin className='w-10' /></a></li>
          </ul>
        </div>
        ...
        <div className='pb-16 pt-10'>
          ...
          <ul className='flex gap-5'>
            <li><a href={`mailto:?subject=${shareText}&body=${shareUrl}`} target="_blank" rel="noopener noreferrer"><Mail className="w-10" /></a></li>

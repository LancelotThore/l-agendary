...
import { updateUserProfile, updateUserSettings, updateUserProfilePicture } from '@/app/api/data';
      ...
      <DialogContent className="sm:max-w-[750px]">
        ...
        <div className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="newPasswordValidator" type='password' value={newPasswordValidator} onChange={(e) => setNewPasswordValidator(e.target.value)} className="col-span-3" />
            {errorPassword && (
